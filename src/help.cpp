...
void show_help(int verbose) {
    ...
    fg = con_fg(f, FG_YELLOW);
    con_fprintf(f, "\033[0;35mOptions:\033[0m\n");
    fg = con_fg(f, fg);
    ...
    {
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\n\033[1;34mCompression tuning options:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
                    ...
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[2;36mBackup options:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
                    ...
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[0;31mOverlay options:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
                    ...
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[1;35mFile system options:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
                    ...
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[1;33mOptions for djgpp2/coff:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
                    "  --coff              produce COFF output [default: EXE]\n"
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[1;33mOptions for dos/com:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
        ...
        con_fprintf(f,
                    ...
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[1;33mOptions for dos/sys:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
        ...
        con_fprintf(f,
                    ...
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[1;36mOptions for watcom/le:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
                    "  --le                produce LE output [default: EXE]\n"
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[1;34mOptions for win32/pe, win64/pe & rtm32/pe:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
                    ...
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[1;32mOptions for linux/elf:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
