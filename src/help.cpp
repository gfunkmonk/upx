...
#else
                "\033[38;2;255;99;71mUPX %-11s\033[0m"
#endif
                "\033[1;30m Markus Oberhumer, Laszlo Molnar & John Reiser\033[0m  \033[38;2;145;200;222m%14s\033[0m\n\n",
#if defined(UPX_VERSION_GITREV)
                gitrev,
...
void show_help(int verbose) {
    ...
    fg = con_fg(f, FG_YELLOW);
    con_fprintf(f, "\033[38;2;194;178;128mOptions:\033[0m\n");
    fg = con_fg(f, fg);
    ...
    if (verbose > 0)
    {
        ...
        con_fprintf(f,
                    ...
                    "\n");
        fg = con_fg(f, FG_YELLOW);
        con_fprintf(f, "\033[38;2;109;129;150mOptions for watcom/le:\033[0m\n");
        fg = con_fg(f, fg);
        con_fprintf(f,
